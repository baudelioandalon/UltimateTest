...
import com.boreal.ultimatetest.rickandmorty.modules.episodes.domain.use_cases.GetListCharactersUseCase
import com.boreal.ultimatetest.rickandmorty.modules.episodes.domain.use_cases.GetListEpisodesUseCase
import com.boreal.ultimatetest.rickandmorty.modules.episodes.domain.use_cases.GetMoreCharactersUseCase
import com.boreal.ultimatetest.rickandmorty.modules.episodes.domain.use_cases.GetMoreEpisodesUseCase
import com.boreal.ultimatetest.rickandmorty.modules.locations.domain.interfaces.LocationsRepository
import com.boreal.ultimatetest.rickandmorty.modules.locations.domain.use_cases.GetListLocationsUseCase
import com.boreal.ultimatetest.rickandmorty.modules.locations.domain.use_cases.GetMoreLocationsUseCase
